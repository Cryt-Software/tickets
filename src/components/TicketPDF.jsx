...
Font.register({
  ...
  fonts: [
    {
      src: 'https://fonts.gstatic.com/s/helvetica/v17/Helvetica-Regular.ttf',
      fontWeight: 'normal',
    },
    {
      src: 'https://fonts.gstatic.com/s/helvetica/v17/Helvetica-Bold.ttf',
      fontWeight: 'bold',
    },
  ],
});
    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.container}>
        ...
        <View style={styles.notesSection}>
          ...
          <Text style={styles.notesList}>• Arrive 15 minutes before the event starts</Text>
          <Text style={styles.notesList}>• Bring valid ID (18+ years required)</Text>
          <Text style={styles.notesList}>• Present this ticket at venue entry</Text>
          <Text style={styles.notesList}>• This booking is non-refundable</Text>
        </View>
